...
class TuringMachineSimulator:
    ...
    def pilihan(self):
        self.pilihan_frame = Frame(self.window, width=400, height=400)
        self.pilihan_frame.grid(row=2, column=0, sticky='nsew')

        self.label = Label(self.pilihan_frame, text="Pilihan:", justify="left")
        self.label.grid(row=2, column=0, sticky="w")

        self.menu_entry = Entry(self.pilihan_frame)
        self.menu_entry.grid(row=2, column=1, sticky="w")

        self.submit_button = Button(self.pilihan_frame, text="Submit", command=self.handle_submit)
        self.submit_button.grid(row=2, column=2, sticky="w")

        self.result_label = Label(self.pilihan_frame, text="")

        self.input1 = Label(self.pilihan_frame, text="Angka 1")
        self.angka1_entry = Entry(self.pilihan_frame)

        self.input2 = Label(self.pilihan_frame, text="Angka 2")
        self.angka2_entry = Entry(self.pilihan_frame)

        self.submit_operation = Button(self.pilihan_frame, text="")
        self.result_accept = Label(self.pilihan_frame, text="")
        self.result_calculation = Label(self.pilihan_frame, text="")
    ...
    def create_header(self):
        ...
        header_label.grid(columnspan=5, sticky="nsew")
