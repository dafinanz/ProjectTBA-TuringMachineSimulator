...
class TuringMachineSimulator:
    def __init__(self):
        ...
        self.menu_entry.grid(row=3, column=0, sticky="w")
    ...
    def create_header(self):
        ...
        header_label = Label(header_frame, text="Turing Machine Simulator", font=("Roboto", 24, "bold"), fg="white", bg="#3c8aae")
        header_label.grid(row=0, column=0, sticky="w", padx=10, pady=10)
